...
class Livro:
    ...
    def __init__(self, id: int, titulo: str, resumo: str, ano: str, paginas: str, isbn: str, categoria: Categoria, editora: Editora, autor: Autor):
        self.__id: int = id
        ...
        self.__editoria: Editora = editora
    ...
    def editora(self) -> Editora:
        return self.__editoria


    @editora.setter
    def editora(self, editora: Editora):
        self.__editoria = editora
