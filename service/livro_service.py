...
class LivroService:
    ...
    def listar(self):
        ...
        try:
            ...
            for livro in livros:
                print(f'Id: {livro.id} | Título: {livro.titulo} | Resumo: {livro.resumo} | Ano: {livro.ano} | Páginas: {livro.paginas} | ISBN: {livro.isbn} | Categoria: {livro.categoria.nome} | Editora: {livro.editora.nome} | Autor: {livro.autor.nome}')
    ...
    def adicionar(self):
        ...
        try:
            ...
            paginas = input('Digite a quant. de páginas do livro: ')
